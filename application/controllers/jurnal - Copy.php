...
$this->load->model('model_app');
    ...
    function add_jurnal(){
        ...
        $data=array(
			...
			'trans'=>$this->model_app->getdata('jurnal a',"right join (detail_jurnal b left join akun c on b.id_parent=c.id_parent) on a.id_jurnal=b.id_jurnal WHERE b.id_sub_parent='102' group by b.id_parent"),
			//'akun'=>$idparent,
			//'trans'=>$id_parent2,
