...
<div class="page table-responsive" align="right">
    ...
    <tr>
      ...
      <td>&nbsp;</td>
                            ...
                            <table class="table table-striped">
                                              <thead>
                                                <tr>
                                                  ...
                                                  <th>&nbsp;</th>
                                                  <th> <a class="btn-addnew" href="#modaladd" data-toggle="modal" title="Add"><i class="icon-plus icons"></i>Add Trans.</a></th>
                ...
                <i class="fa fa-plus"></i> Add Jurnal S.T
                                                ...
                                                <tr>
                                                <?php
												if($judul=='101'){ $judul='INCOME';}
												else {
												$judul='EXPENSE';}
												
												
												?>
                                                  <th colspan="4"><?php echo isset($judul)?$judul:'';?></th>
                                                  <th>&nbsp;</th>
                                                  <th>&nbsp;</th>
                                                  <th class="text-center">&nbsp;</th>
                                                </tr>
