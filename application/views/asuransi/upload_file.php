...
<form action="<?php echo base_url();?>asuransi/do_upload" method="post" enctype="multipart/form-data">
  <table width="" border="0" id="tabelinput">
    <tr>
    <td height="47" colspan="4"><div align="center">
      <h3>Upload File Surat Kuasa</h3></div></td>
    </tr>
    <tr>
      <td width="16%">Nomor Surat</td>
      <td width="1%">:</td>
      <td width="57%"><input type="text" name="no" id="no"></td>
      <td width="26%">&nbsp;</td>
    </tr>
    <tr>
      <td>Keterangan</td>
      ...
      <textarea name="ket" id="textarea" cols="45" rows="5"></textarea></td>
      <td>&nbsp;</td>
    </tr>
  <tr>
